        ...
        <div class="row align-items-center g-3 g-lg-4">
          ...
          <div class="col-12 col-lg-7 ps-0 ps-lg-4">
            <div class="hero-text mb-5">
              <h1>
                <span class="font-family-expletus color-blue-1 fw-400">Sign</span><span
                  class="font-family-expletus color-red-1 fw-400 d-inline-flex align-items-center gap-3">Up<img src="./image/icons/curveIcon.png" alt="curve" /></span>
              </h1>
            </div>
