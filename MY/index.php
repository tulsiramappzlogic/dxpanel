    ...
    <div class="container d-flex justify-content-between align-items-center">
      ...
      <div class="text-center">
        <h2 class="mb-0 fw-bold">
          <img src="./image/MalaysiaPolls Logo.png" alt="MalaysiaPolls Logo" height="96" width="auto" />
        </h2>
      </div>
    ...
    <div class="row align-items-center">
      ...
      <div class="col-lg-7 ps-lg-4">
        <div class="hero-text mb-4">
          <h1>
            <span class="mytitle">Salam</span><br /><span class="mytitltle2">Malaysia</span>
            <i class="fa fa-chevron-right opacity-50"></i><i class="fa fa-chevron-right opacity-50"></i>
          </h1>
          <p class="lead fw-normal h4">
            Welcome to Malaysia's newest, coolest <br />and most rewarding community!
          </p>
        </div>
