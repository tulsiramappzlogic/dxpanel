...
<head>
    ...
    <title>Sign Up - PhilippinesPolls</title>
                        ...
                        <div class="hero-text mb-5">
                            <h1>
                                <span class="font-family-expletus color-red-1 fw-400">Sign</span><span
                                    class="font-family-expletus color-blue-1 fw-400 d-inline-flex align-items-center gap-3">Up<img src="./image/icons/curveIcon.png" alt="curve" /></span>
                            </h1>
                        </div>
